...
complex tools elsewhere, but GitHub now has great features for that. Why not
...
* Add work items from the [existing repositories litCode and litData](https://github.com/orgs/an-org/repositories?q=lit&type=all&language=&sort=).
...
* Switch views, and modify metadata by dragging the draft issue to "todo".

* Group by milestone, sort by status, filter by assignee, and save a new view.
...
* Notice the status has automatically updated, and everything is linked.
