...
* Setup Git and SSH keys for GitHub. I ([install `gh`](https://github.com/cli/cli/blob/trunk/docs/install_linux.md#debian-ubuntu-linux-raspberry-pi-os-apt)) then login to GitHub with `gh auth login`.
* I install [oh-my-zsh](https://ohmyz.sh/#install) and my dotfiles ([watch how](https://youtu.be/BYtt2cXW4qg)).
